...
public class POST_register {
    ...
    public String invalid_endpoint_register = "https://altashop-api.fly.dev/api/auth/signin";
    ...
    public void sendPOSTHTTPRequestWithValidEndpointForRegister(){
        ...
        String email = "dianakd" + String.valueOf(number) + "@gmail.com";

        String body = "{\"email\": " + email + ",\n" +
                " \"password\": \"dianacantik\" ,\n" +
    ...
    public void sendPOSTHTTPRequestWithInvalidEndpointForRegister(){
        String body = "{\"email\": \"kusuma@gmail.com\", \"password\": \"kusumabangsa\", \"fullname\": \"Kusuma Bangsa\"}";
