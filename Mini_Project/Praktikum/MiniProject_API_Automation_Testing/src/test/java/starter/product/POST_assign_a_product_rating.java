...
public class POST_assign_a_product_rating {
    public String POST_valid_endpoint_product_rating = "https://altashop-api.fly.dev/api/products/85573/ratings";
    public String POST_invalid_endpoint_product_rating = "https://altashop-api.fly.dev/api/products/8585/rating";
    public String POST_endpoint_empty_product_rating = "https://altashop-api.fly.dev/api/products/85544/ratings";
    ...
    public void validateValidDataForAssignProductRating(){
        restAssuredThat(response->response.body("data.Name",equalTo("Mango")));
        restAssuredThat(response->response.body("data.Description",equalTo("Fruit good")));
        restAssuredThat(response->response.body("data.Price",equalTo(9000)));
