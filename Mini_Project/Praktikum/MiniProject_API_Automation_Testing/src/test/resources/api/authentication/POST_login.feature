Feature: POST - login
  ...
  @TCA2.1
  Scenario: POST - as a user i want to login with valid endpoint and data
  ...
  @TCA2.4
  Scenario: POST - as a user i want to login with input invalid data email and password
    Given user set POST valid endpoint for login
