...
public class GET_product_by_ID {
    public String validEndpointProductByID = "https://altashop-api.fly.dev/api/products/85547";
    public String invalidEndpointProductByID = "https://altashop-api.fly.dev/api/product/8585";
