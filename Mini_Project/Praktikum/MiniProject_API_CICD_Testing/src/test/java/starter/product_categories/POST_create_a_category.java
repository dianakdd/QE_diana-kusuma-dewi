...
public class POST_create_a_category {
    ...
    public void sendPOSTHTTPRequestForCreateACategory(){
        String body = "{ \"name\":\"gaming\", \"description\": \"Valorant itu game terbaik\"}";
    ...
    public void validateValidDataForNewCategory(){
        ...
        restAssuredThat(response->response.body("data.Description",equalTo("Valorant itu game terbaik")));
    }
}
