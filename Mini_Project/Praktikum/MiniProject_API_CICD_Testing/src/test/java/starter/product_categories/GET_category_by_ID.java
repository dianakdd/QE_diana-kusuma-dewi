...
public class GET_category_by_ID {
    public String validEndpointCategoryByID = "https://altashop-api.fly.dev/api/categories/29785";
    public String invalidEndpointCategoryByID = "https://altashop-api.fly.dev/api/category/1";
